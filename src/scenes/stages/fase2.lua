...
local background = display.newImageRect(backGroup, "assets/images/backgrounds/fase2BG.png", 1200, 600)
...
local tombstone = display.newImageRect(mainGroup, "assets/images/backgrounds/tomb2.png", 40, 40)
